...
-module(dsdc_object_serialization_tests).
...
deserialize(Template, Bin, Tag, Vsn) ->
    dsdc_object_serialization:deserialize(Tag, Vsn, Template, Bin).

serialize(Template, Bin) ->
    serialize(Template, Bin, ?DEFAULT_TAG, ?DEFAULT_VERSION).

serialize(Template, Bin, Tag, Vsn) ->
    dsdc_object_serialization:serialize(Tag, Vsn, Template, Bin).
