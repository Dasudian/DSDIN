...
-define(lazy(F),     {dsdso_parse_lazy, F}).
-define(fail(Err),   {dsdso_parse_fail, Err}).
-define(choice(Ps),  {dsdso_parse_choice, Ps}).
-define(bind(P, F),  {dsdso_parse_bind, P, F}).
-define(right(P, Q), {dsdso_parse_right, P, Q}).
-define(left(P, Q),  {dsdso_parse_left, P, Q}).
-define(map(F, P),   {dsdso_parse_map, F, P}).
-define(layout,       dsdso_parse_layout).
-define(tok(Atom),   {dsdso_parse_tok, Atom}).
-define(return(X),   {dsdso_parse_return, X}).
