...
-define(LET_P(X, P, Q), dsdso_parse_lib:bind(P, fun(X) -> Q end)).
-define(LAZY_P(P),      dsdso_parse_lib:lazy(fun() -> P end)).
-define(MEMO_P(P),      dsdso_parse_lib:lazy(dsdso_parse_lib:memoised(fun() -> P end))).
